...
def generate_executive_summary(result: UnifiedValidationResult, request_id: str | None = None, include_recommendations: bool = True) -> str:
...
def _generate_mape_row(var, assessment: str) -> str:
...
def _generate_metrics_rows(metrics) -> list[str]:

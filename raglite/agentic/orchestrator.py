...
from raglite.agentic.orchestrator_tools import load_default_tools, register_tools
...
class StrandsOrchestrator:
    ...
    def __init__(self) -> None:
        ...
        self._registered_tools: list[Callable] = load_default_tools()
    ...
    def register_tools(self, tools: list[Callable]) -> None:
        ...
        """
        register_tools(self._registered_tools, tools)
...
from raglite.agentic.orchestrator_workflow import WorkflowExecutor  # noqa: E402

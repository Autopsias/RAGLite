...
ENTITY_CANONICAL_MAP: dict[str, str] = {
    ...
    # Epic 9 multi-entity: Comprehensive GROUP entity mapping
    "Conso": "Group",
    "CONSO": "Group",
    "Consolidated": "Group",
    "CONSOLIDATED": "Group",
...
# Epic 9 multi-entity: Comprehensive synonym mapping for all supported entities
ENTITY_SYNONYMS: dict[str, list[str]] = {
    "portugal": ["Portugal", "PT", "Portugal Cement", "Secil Portugal", "Cimento de Portugal"],
    "brazil": ["Brazil", "BR", "Brasil", "Brazil Cement", "Secil Brazil", "Secil Brasil"],
    "tunisia": ["Tunisia", "TN", "Tunisie", "Tunisia Cement", "Secil Tunisia", "Secil Tunisie"],
    "lebanon": ["Lebanon", "LB", "Liban", "Lebanon Cement", "Secil Lebanon", "Secil Liban"],
    "angola": ["Angola", "AO", "Angola Cement", "Secil Angola"],
    "cape verde": ["Cape Verde", "CV", "Cabo Verde", "Cape Verde Cement", "Secil Cape Verde"],
    "group": [
        "Group",
        "GROUP",
        "Conso",

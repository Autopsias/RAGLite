...
### Database Discovery (for AI Agents)

**Use this section to find production data locations.**
...
## MCP Tools - Document Ingestion (Story 4.0.7)
...
### 🚨 Test Infrastructure Rules (MANDATORY)

**These rules prevent recurring test performance regressions. Follow them for ALL test changes.**

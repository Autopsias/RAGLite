...
Generated: 2026-01-30T10:27:44.953894
Runtime: 476.7 seconds
...
| Metric | Value | Target | Status | Interpretation |
|--------|-------|--------|--------|----------------|
| MAPE | 111.16% | <100.0% | ✅ MASE-ONLY | MASE 0.28 passed (MAPE waived) |
| MASE | 0.28 | <1.0 | ✅ PASS | Beats naïve by 72% |
| SMAPE | 150.12% | - | INFO | Symmetric error |
| RMSE | 73.49 | - | INFO | Error in original units |
| MAE | 45.74 | - | INFO | Average absolute error |
| Bias | -45.72 | ~0 | ⚠️ WARN | Tends to under-predict |
...
|----------|-------|---------|--------|-----|
| EBITDA | Exceeds target | 111.16% | 100.0% | +11.16% |
...
Electricity Cost, Variable Cost per Ton, Average Selling Price, Portugal GDP Growth (YoY), Portugal HICP Inflation, Diesel Price (EU), Construction Output Index, Industrial Production Index, Building Permits (Portugal), Construction Confidence Indicator
...
| Variable | Bias | Alert |
|----------|------|-------|
| EBITDA | -45.72 | Systematic under-prediction detected (bias=-45.72) |
...
| 4 | EBITDA | 0.28 | 72% better |
| 5 | 3-Month EURIBOR Rate | 0.31 | 69% better |
| 6 | Diesel Price (EU) | 0.31 | 69% better |
| 7 | Portugal GDP Growth (YoY) | 0.33 | 67% better |
...
| 4 | EBITDA | 86.2 | Excellent |
| 5 | 3-Month EURIBOR Rate | 84.7 | Excellent |
| 6 | Diesel Price (EU) | 84.5 | Excellent |
| 7 | Portugal GDP Growth (YoY) | 83.3 | Excellent |

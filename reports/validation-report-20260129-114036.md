...
Generated: 2026-01-29T11:40:36.249088
Runtime: 393.4 seconds
...
**Average MAPE:** 140.09%
**Average MASE:** 5.16 (worse than naïve)
**Average FQS:** 57.6/100 (Moderate)
...
| Metric | Value | Target | Status | Interpretation |
|--------|-------|--------|--------|----------------|
| MAPE | 1544.64% | <5.0% | ❌ FAIL | Critical - needs investigation |
| MASE | 67.29 | <1.0 | ❌ FAIL | Worse than naïve by 6629% |
| SMAPE | 175.94% | - | INFO | Symmetric error |
| RMSE | 3674.21 | - | INFO | Error in original units |
| MAE | 3661.27 | - | INFO | Average absolute error |
| Bias | +3661.27 | ~0 | ⚠️ WARN | Tends to over-predict |
...
|----------|-------|------|----------------|
| EBITDA | MASE >1.0 | 67.29 | Evaluate model configuration |
...
**EBITDA** - MAPE 1544.6% and MASE 67.29 both poor
...
| Variable | Bias | Alert |
|----------|------|-------|
| EBITDA | 3661.27 | Systematic over-prediction detected (bias=3661.27) |
...
| 14 | Electricity Cost | 3.01 | 201% worse |
| 15 | Variable Cost per Ton | 4.68 | 368% worse |
| 16 | EBITDA | 67.29 | 6629% worse |
...
3. **Electricity Cost** - MASE 3.01 (201% worse than naïve)
4. **Variable Cost per Ton** - MASE 4.68 (368% worse than naïve)
5. **EBITDA** - MASE 67.29 (6629% worse than naïve)

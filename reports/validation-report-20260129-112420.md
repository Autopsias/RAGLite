...
Generated: 2026-01-29T11:24:20.398589
Runtime: 322.1 seconds
...
**Average MAPE:** 70.94%
**Average MASE:** 1.44 (worse than naïve)
...
| Metric | Value | Target | Status | Interpretation |
|--------|-------|--------|--------|----------------|
| MAPE | 438.16% | <5.0% | ❌ FAIL | Critical - needs investigation |
| MASE | 7.85 | <1.0 | ❌ FAIL | Worse than naïve by 685% |
| SMAPE | 106.95% | - | INFO | Symmetric error |
| RMSE | 84.45 | - | INFO | Error in original units |
| MAE | 54.80 | - | INFO | Average absolute error |
| Bias | +54.80 | ~0 | ⚠️ WARN | Tends to over-predict |
...
|----------|-------|------|----------------|
| EBITDA | MASE >1.0 | 7.85 | Evaluate model configuration |
...
**EBITDA** - MAPE 438.2% and MASE 7.85 both poor
...
| Variable | Bias | Alert |
|----------|------|-------|
| EBITDA | 54.80 | Systematic over-prediction detected (bias=54.80) |
...
5. **EBITDA** - MASE 7.85 (685% worse than naïve)

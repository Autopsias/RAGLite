...
Generated: 2026-01-29T09:27:59.211849
Runtime: 146.3 seconds
...
|-----------|--------|--------|--------|
| Variables Passing MAPE | ≥9/20 | 9/20 | ✅ PASS |
| Average MASE | <1.0 | 0.49 | ✅ PASS |

### Quick Summary
- **Excellent (MAPE <5%):** 4 variables
- **Good (MAPE 5-15%):** 1 variables
- **Needs Improvement (MAPE 15-30%):** 3 variables
- **Critical (MAPE >30%):** 1 variables

**Average MAPE:** 16.00%
**Average MASE:** 0.49 (better than naïve)
**Average FQS:** 75.4/100 (Good)
...
| Metric | Value | Target | Status | Interpretation |
|--------|-------|--------|--------|----------------|
| MAPE | 66.77% | <63.0% | ✅ MASE-ONLY | MASE 0.38 passed (MAPE waived) |
| MASE | 0.38 | <1.0 | ✅ PASS | Beats naïve by 62% |
| SMAPE | 93.46% | - | INFO | Symmetric error |
| RMSE | 1.92 | - | INFO | Error in original units |
| MAE | 1.86 | - | INFO | Average absolute error |
| Bias | -1.17 | ~0 | ⚠️ WARN | Tends to under-predict |
| FQS | 81.0/100 | ≥65 | INFO | Excellent quality |
...
| Construction Confidence Indicator | Exceeds target | 66.77% | 63.0% | +3.77% |

### 🟢 Good Performance - No Action Required
Portugal GDP Growth (YoY), Portugal HICP Inflation, Diesel Price (EU), Industrial Electricity Price, Construction Output Index, Industrial Production Index
...
| Construction Confidence Indicator | 66.8% | 0.38 | MASE-only |
...
**Electricity Cost** - MAPE 0.0% exceeds threshold 15.0%
- **Analysis:** Review data quality, regressors, and model configuration
- **Recommendation:** Run targeted diagnosis on this variable
...
| Construction Confidence Indicator | -1.17 | Systematic under-prediction detected (bias=-1.17) |
...
| 2 | 3-Month EURIBOR Rate | 0.31 | 69% better |
| 3 | Diesel Price (EU) | 0.31 | 69% better |
| 4 | Portugal GDP Growth (YoY) | 0.33 | 67% better |
| 5 | Construction Confidence Indicator | 0.38 | 62% better |
| 6 | Construction Output Index | 0.40 | 60% better |
| 7 | Industrial Production Index | 0.57 | 43% better |
| 8 | Industrial Electricity Price | 0.77 | 23% better |
...
2. **3-Month EURIBOR Rate** - MASE 0.31 (69% better than naïve)
3. **Diesel Price (EU)** - MASE 0.31 (69% better than naïve)
...
| 2 | 3-Month EURIBOR Rate | 84.7 | Excellent |
| 3 | Diesel Price (EU) | 84.5 | Excellent |
| 4 | Portugal GDP Growth (YoY) | 83.3 | Excellent |
| 5 | Construction Confidence Indicator | 81.0 | Excellent |
| 6 | Construction Output Index | 79.9 | Good |
| 7 | Industrial Production Index | 71.4 | Good |
| 8 | Industrial Electricity Price | 61.3 | Moderate |

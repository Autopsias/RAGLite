...
Generated: 2026-01-29T11:10:12.344222
Runtime: 320.2 seconds
...
**Average MAPE:** 109.79%
**Average MASE:** 2.30 (worse than naïve)
...
| Metric | Value | Target | Status | Interpretation |
|--------|-------|--------|--------|----------------|
| MAPE | 1059.75% | <5.0% | ❌ FAIL | Critical - needs investigation |
| MASE | 21.46 | <1.0 | ❌ FAIL | Worse than naïve by 2046% |
| SMAPE | 174.77% | - | INFO | Symmetric error |
| RMSE | 189.40 | - | INFO | Error in original units |
| MAE | 140.33 | - | INFO | Average absolute error |
| Bias | -126.37 | ~0 | ⚠️ WARN | Tends to under-predict |
...
|----------|-------|------|----------------|
| EBITDA | MASE >1.0 | 21.46 | Evaluate model configuration |
...
**EBITDA** - MAPE 1059.8% and MASE 21.46 both poor
...
| Variable | Bias | Alert |
|----------|------|-------|
| EBITDA | -126.37 | Systematic under-prediction detected (bias=-126.37) |
...
5. **EBITDA** - MASE 21.46 (2046% worse than naïve)

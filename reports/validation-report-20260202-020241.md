...
Generated: 2026-02-02T02:02:41.331029
Runtime: 437.9 seconds
...
**Average MAPE:** 130.33%
**Average MASE:** 1.09 (worse than naïve)
**Average FQS:** 60.9/100 (Moderate)
...
| Metric | Value | Target | Status | Interpretation |
|--------|-------|--------|--------|----------------|
| MAPE | 312.79% | <10.0% | ❌ FAIL | Critical - needs investigation |
| MASE | 7.09 | <1.0 | ❌ FAIL | Worse than naïve by 609% |
| SMAPE | 148.25% | - | INFO | Symmetric error |
| RMSE | 56.75 | - | INFO | Error in original units |
| MAE | 38.65 | - | INFO | Average absolute error |
| Bias | +25.55 | ~0 | INFO | Tends to over-predict |
...
| Metric | Value | Target | Status | Interpretation |
|--------|-------|--------|--------|----------------|
| MAPE | 18.96% | <70.0% | ❌ FAIL | Moderate - needs investigation |
...
| Metric | Value | Target | Status | Interpretation |
|--------|-------|--------|--------|----------------|
| MAPE | 20.80% | <23.0% | ✅ PASS (MAPE) | Poor for FP&A reporting |
| MASE | 0.27 | <1.0 | ✅ PASS | Beats naïve by 73% |
| SMAPE | 23.98% | - | INFO | Symmetric error |
| RMSE | 0.48 | - | INFO | Error in original units |
| MAE | 0.42 | - | INFO | Average absolute error |
| Bias | -0.42 | ~0 | ⚠️ WARN | Tends to under-predict |
| FQS | 83.9/100 | ≥65 | INFO | Excellent quality |
...
| Thermal Energy Cost | MASE >1.0 | 7.09 | Evaluate model configuration |
...
| 3-Month EURIBOR Rate | Near threshold | 20.80% | 23.0% | -2.20% |

### 🟢 Good Performance - No Action Required
Average Selling Price, Portugal GDP Growth (YoY), Portugal HICP Inflation, Diesel Price (EU), Construction Output Index, Industrial Production Index, Building Permits (Portugal), Construction Confidence Indicator
...
| 3-Month EURIBOR Rate | 20.8% | 0.27 | Primary |
...
**Thermal Energy Cost** - MAPE 312.8% and MASE 7.09 both poor
...
**Variable Cost per Ton** - MAPE 19.0% exceeds threshold 70.0%
- **Analysis:** Review data quality, regressors, and model configuration
- **Recommendation:** Run targeted diagnosis on this variable
...
| Thermal Energy Cost | 25.55 | Systematic over-prediction detected (bias=25.55) |
...
| 3-Month EURIBOR Rate | -0.42 | Systematic under-prediction detected (bias=-0.42) |
...
| 3 | 3-Month EURIBOR Rate | 0.27 | 73% better |
| 4 | Construction Confidence Indicator | 0.30 | 70% better |
| 5 | Diesel Price (EU) | 0.30 | 70% better |
| 6 | Portugal GDP Growth (YoY) | 0.33 | 67% better |
| 7 | Construction Output Index | 0.39 | 61% better |
| 8 | Electricity Cost | 0.43 | 57% better |
| 9 | Industrial Production Index | 0.60 | 40% better |
| 10 | Average Selling Price | 0.64 | 36% better |
| 11 | Building Permits (Portugal) | 0.85 | 15% better |
| 12 | Capacity Utilization | 1.40 | 40% worse |
| 13 | Revenue | 1.41 | 41% worse |
| 14 | Variable Cost per Ton | 1.59 | 59% worse |
| 15 | Sales Volume | 1.79 | 79% worse |
| 16 | Thermal Energy Cost | 7.09 | 609% worse |
...
3. **3-Month EURIBOR Rate** - MASE 0.27 (73% better than naïve)
...
4. **Sales Volume** - MASE 1.79 (79% worse than naïve)
5. **Thermal Energy Cost** - MASE 7.09 (609% worse than naïve)
...
| 4 | 3-Month EURIBOR Rate | 83.9 | Excellent |
| 5 | Industrial Production Index | 79.9 | Good |
| 6 | Portugal GDP Growth (YoY) | 79.4 | Good |
| 7 | Average Selling Price | 77.6 | Good |
| 8 | Construction Confidence Indicator | 74.8 | Good |
| 9 | Building Permits (Portugal) | 68.6 | Good |
| 10 | EBITDA | 62.5 | Moderate |
| 11 | Revenue | 53.9 | Moderate |
| 12 | Electricity Cost | 51.1 | Moderate |
| 13 | Variable Cost per Ton | 41.8 | Poor |
| 14 | Capacity Utilization | 19.5 | Poor |
| 15 | Sales Volume | 6.9 | Poor |
| 16 | Thermal Energy Cost | 0.0 | Poor |

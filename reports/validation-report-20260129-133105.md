...
Generated: 2026-01-29T13:31:05.188876
Runtime: 283.8 seconds
...
|-----------|--------|--------|--------|
| Variables Passing MAPE | ≥9/20 | 13/20 | ✅ PASS |
| Variable Cost MAPE | <35.0% | 65.18% | ❌ FAIL |
...
| Metric | Value | Target | Status | Interpretation |
|--------|-------|--------|--------|----------------|
| MAPE | 100.00% | <50.0% | ❌ FAIL | Critical - needs investigation |
...
| Metric | Value | Target | Status | Interpretation |
|--------|-------|--------|--------|----------------|
| MAPE | 78.96% | <50.0% | ❌ FAIL | Critical - needs investigation |
...
| Metric | Value | Target | Status | Interpretation |
|--------|-------|--------|--------|----------------|
| MAPE | 65.18% | <35.0% | ❌ FAIL | Critical - needs investigation |
...
| Metric | Value | Target | Status | Interpretation |
|--------|-------|--------|--------|----------------|
| MAPE | 227.98% | <50.0% | ❌ FAIL | Critical - needs investigation |
...
**Variable Cost per Ton** - MAPE 65.2% and MASE 2.27 both poor
- **Root Cause:** Likely data quality issue (entity mixing, wrong aliases, scale mismatch)
- **Fix:** 1) Check db_metric_aliases for incorrect mappings
2) Verify entity filter (GROUP vs individual entities)
3) Check for scale mismatches (thousands vs units)
...
**EBITDA** - MAPE 100.0% exceeds threshold 50.0%

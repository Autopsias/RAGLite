...
Generated: 2026-01-29T13:49:30.647090
Runtime: 287.8 seconds
...
**Average MAPE:** 43.08%
**Average MASE:** 0.92 (better than naïve)
**Average FQS:** 57.9/100 (Moderate)
...
| Metric | Value | Target | Status | Interpretation |
|--------|-------|--------|--------|----------------|
| MAPE | 227.98% | <50.0% | ✅ MASE-ONLY | MASE 1.07 passed (MAPE waived) |
...
| Capacity Utilization | 228.0% | 1.07 | MASE-only |
...
| 13 | Revenue | 1.12 | 12% worse |
| 14 | Building Permits (Portugal) | 1.29 | 29% worse |
| 15 | EBITDA | 1.63 | 63% worse |
| 16 | Variable Cost per Ton | 2.27 | 127% worse |
| 17 | Electricity Cost | 3.01 | 201% worse |
...
2. **Revenue** - MASE 1.12 (12% worse than naïve)
3. **Building Permits (Portugal)** - MASE 1.29 (29% worse than naïve)
4. **EBITDA** - MASE 1.63 (63% worse than naïve)
...
| 13 | Revenue | 43.9 | Poor |
| 14 | Building Permits (Portugal) | 35.3 | Poor |
| 15 | EBITDA | 18.6 | Poor |
| 16 | Electricity Cost | 0.0 | Poor |
| 17 | Variable Cost per Ton | 0.0 | Poor |

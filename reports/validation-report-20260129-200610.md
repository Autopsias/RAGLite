...
Generated: 2026-01-29T20:06:10.085335
Runtime: 454.6 seconds
...
**Average MAPE:** 61.82%
**Average MASE:** 0.66 (better than naïve)
**Average FQS:** 67.0/100 (Good)
...
| Metric | Value | Target | Status | Interpretation |
|--------|-------|--------|--------|----------------|
| MAPE | 283.65% | <100.0% | ✅ MASE-ONLY | MASE 1.41 passed (MAPE waived) |
| MASE | 1.41 | <1.0 | ❌ FAIL | Worse than naïve by 41% |
| SMAPE | 145.79% | - | INFO | Symmetric error |
| RMSE | 126324.08 | - | INFO | Error in original units |
| MAE | 104653.67 | - | INFO | Average absolute error |
| Bias | -96783.10 | ~0 | ⚠️ WARN | Tends to under-predict |
| FQS | 29.6/100 | ≥65 | INFO | Poor quality |
...
| Metric | Value | Target | Status | Interpretation |
|--------|-------|--------|--------|----------------|
| MAPE | 427.06% | <50.0% | ✅ MASE-ONLY | MASE 1.72 passed (MAPE waived) |
...
| EBITDA | MASE >1.0 | 1.41 | Evaluate model configuration |
...
Electricity Cost, Variable Cost per Ton, Average Selling Price, Portugal GDP Growth (YoY), Portugal HICP Inflation, Diesel Price (EU), Construction Output Index, Industrial Production Index, Construction Confidence Indicator
...
| Capacity Utilization | 427.1% | 1.72 | MASE-only |
...
| Variable | Bias | Alert |
|----------|------|-------|
| EBITDA | -96783.10 | Systematic under-prediction detected (bias=-96783.10) |
...
| 8 | Variable Cost per Ton | 0.45 | 55% better |
| 9 | Industrial Production Index | 0.57 | 43% better |
| 10 | Average Selling Price | 0.64 | 36% better |
| 11 | Thermal Energy Cost | 0.77 | 23% better |
| 12 | Sales Volume | 0.77 | 23% better |
| 13 | Revenue | 1.12 | 12% worse |
| 14 | Building Permits (Portugal) | 1.29 | 29% worse |
| 15 | EBITDA | 1.41 | 41% worse |
...
3. **EBITDA** - MASE 1.41 (41% worse than naïve)
4. **Capacity Utilization** - MASE 1.72 (72% worse than naïve)
...
| 8 | Variable Cost per Ton | 77.4 | Good |
| 9 | Industrial Production Index | 71.4 | Good |
| 10 | Average Selling Price | 67.8 | Good |
| 11 | Thermal Energy Cost | 61.7 | Moderate |
| 12 | Sales Volume | 61.5 | Moderate |

...
Generated: 2025-12-24T03:09:26.365831
Runtime: 142.3 seconds
...
**Average MAPE:** 17.97%
**Average MASE:** 0.46 (better than naïve)
**Average FQS:** 78.7/100 (Good)
...
| Metric | Value | Target | Status | Interpretation |
|--------|-------|--------|--------|----------------|
| MAPE | 16.74% | <15.0% | ✅ MASE-ONLY | MASE 0.16 passed (MAPE waived) |
| MASE | 0.16 | <1.0 | ✅ PASS | Beats naïve by 84% |
| SMAPE | 15.01% | - | INFO | Symmetric error |
| RMSE | 12.37 | - | INFO | Error in original units |
| MAE | 10.70 | - | INFO | Average absolute error |
| Bias | +9.77 | ~0 | ⚠️ WARN | Tends to over-predict |
| FQS | 88.8/100 | ≥65 | INFO | Excellent quality |
...
|----------|-------|---------|--------|-----|
| Electricity Cost | Exceeds target | 16.74% | 15.0% | +1.74% |
...
|----------|------|------|--------|
| Electricity Cost | 16.7% | 0.16 | MASE-only |
...
| 3 | Electricity Cost | 88.8 | Excellent |

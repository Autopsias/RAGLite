...
Generated: 2025-12-17T00:15:31.370208
Runtime: 524.8 seconds
...
| Metric | Value | Target | Status | Interpretation |
|--------|-------|--------|--------|----------------|
| MAPE | 303.60% | <10.0% | ❌ FAIL | Critical - needs investigation |
...
| Metric | Value | Target | Status | Interpretation |
|--------|-------|--------|--------|----------------|
| MAPE | 25.57% | <8.0% | ❌ FAIL | Poor - needs investigation |
...
| Metric | Value | Target | Status | Interpretation |
|--------|-------|--------|--------|----------------|
| MAPE | 14.52% | <10.0% | ❌ FAIL | Moderate - needs investigation |
...
| Metric | Value | Target | Status | Interpretation |
|--------|-------|--------|--------|----------------|
| MAPE | 48.81% | <8.0% | ✅ MASE-ONLY | MASE 0.90 passed (MAPE waived) |
...
| Metric | Value | Target | Status | Interpretation |
|--------|-------|--------|--------|----------------|
| MAPE | 5660.30% | <9.0% | ❌ FAIL | Critical - needs investigation |
...
| Metric | Value | Target | Status | Interpretation |
|--------|-------|--------|--------|----------------|
| MAPE | 50.01% | <25.0% | ❌ FAIL | Critical - needs investigation |
...
| Variable Cost per Ton | 48.8% | 0.90 | MASE-only |
...
**Sales Volume** - MAPE 303.6% and MASE 8.82 both poor
...
**Average Selling Price** - MAPE 5660.3% and MASE 231.70 both poor
- **Root Cause:** Likely data quality issue (entity mixing, wrong aliases, scale mismatch)
- **Fix:** 1) Check db_metric_aliases for incorrect mappings
2) Verify entity filter (GROUP vs individual entities)
3) Check for scale mismatches (thousands vs units)
...
**CO2 EUA Price** - MAPE 50.0% and MASE 7.63 both poor
- **Root Cause:** Likely data quality issue (entity mixing, wrong aliases, scale mismatch)
- **Fix:** 1) Check db_metric_aliases for incorrect mappings
2) Verify entity filter (GROUP vs individual entities)
3) Check for scale mismatches (thousands vs units)
...
| Sales Volume | 13334.85 | Systematic over-prediction detected (bias=13334.85) |
| Electricity Cost | 60.98 | Systematic over-prediction detected (bias=60.98) |
| Variable Cost per Ton | 473.36 | Systematic over-prediction detected (bias=473.36) |
| Natural Gas Price (TTF) | 9.80 | Systematic over-prediction detected (bias=9.80) |
| Average Selling Price | -40259.58 | Systematic under-prediction detected (bias=-40259.58) |
| CO2 EUA Price | -11.38 | Systematic under-prediction detected (bias=-11.38) |

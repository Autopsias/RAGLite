...
Generated: 2026-01-29T14:26:05.160774
Runtime: 332.5 seconds
...
| Variable Cost MAPE | <70.0% | 65.18% | ✅ PASS |
| Average MASE | <1.0 | 1.67 | ❌ FAIL |
...
**Average MAPE:** 59.70%
**Average MASE:** 1.67 (worse than naïve)
**Average FQS:** 52.6/100 (Moderate)
...
| Metric | Value | Target | Status | Interpretation |
|--------|-------|--------|--------|----------------|
| MAPE | 100.00% | <100.0% | ✅ MASE-ONLY | MASE 1.63 passed (MAPE waived) |
| MASE | 1.63 | <1.0 | ❌ FAIL | Worse than naïve by 63% |
| SMAPE | 200.00% | - | INFO | Symmetric error |
| RMSE | 54.08 | - | INFO | Error in original units |
| MAE | 35.70 | - | INFO | Average absolute error |
| Bias | -35.70 | ~0 | ⚠️ WARN | Tends to under-predict |
| FQS | 18.6/100 | ≥65 | INFO | Poor quality |
...
| Metric | Value | Target | Status | Interpretation |
|--------|-------|--------|--------|----------------|
| MAPE | 78.96% | <80.0% | ✅ MASE-ONLY | MASE 3.01 passed (MAPE waived) |
...
| Metric | Value | Target | Status | Interpretation |
|--------|-------|--------|--------|----------------|
| MAPE | 65.18% | <70.0% | ✅ MASE-ONLY | MASE 2.27 passed (MAPE waived) |
| MASE | 2.27 | <1.0 | ❌ FAIL | Worse than naïve by 127% |
| SMAPE | 111.55% | - | INFO | Symmetric error |
| RMSE | 62.22 | - | INFO | Error in original units |
| MAE | 56.92 | - | INFO | Average absolute error |
| Bias | -40.65 | ~0 | ⚠️ WARN | Tends to under-predict |
| FQS | 0.0/100 | ≥65 | INFO | Poor quality |
...
| Metric | Value | Target | Status | Interpretation |
|--------|-------|--------|--------|----------------|
| MAPE | 406.84% | <50.0% | ❌ FAIL | Critical - needs investigation |
| MASE | 1.64 | <1.0 | ❌ FAIL | Worse than naïve by 64% |
| SMAPE | 134.08% | - | INFO | Symmetric error |
| RMSE | 31.18 | - | INFO | Error in original units |
| MAE | 31.18 | - | INFO | Average absolute error |
| Bias | +31.18 | ~0 | ⚠️ WARN | Tends to over-predict |
| FQS | 17.9/100 | ≥65 | INFO | Poor quality |
...
| Metric | Value | Target | Status | Interpretation |
|--------|-------|--------|--------|----------------|
| MAPE | 110.18% | <20.0% | ❌ FAIL | Critical - needs investigation |
| MASE | 13.06 | <1.0 | ❌ FAIL | Worse than naïve by 1206% |
| SMAPE | 113.98% | - | INFO | Symmetric error |
| RMSE | 0.30 | - | INFO | Error in original units |
| MAE | 0.24 | - | INFO | Average absolute error |
| Bias | -0.17 | ~0 | ⚠️ WARN | Tends to under-predict |
| FQS | 0.0/100 | ≥65 | INFO | Poor quality |
...
| EBITDA | MASE >1.0 | 1.63 | Evaluate model configuration |
| Electricity Cost | MASE >1.0 | 3.01 | Evaluate model configuration |
| Variable Cost per Ton | MASE >1.0 | 2.27 | Evaluate model configuration |
| Capacity Utilization | MASE >1.0 | 1.64 | Evaluate model configuration |
| Industrial Electricity Price | MASE >1.0 | 13.06 | Evaluate model configuration |
...
Average Selling Price, Portugal GDP Growth (YoY), Portugal HICP Inflation, Diesel Price (EU), Construction Output Index, Industrial Production Index, Construction Confidence Indicator
...
| EBITDA | 100.0% | 1.63 | MASE-only |
| Sales Volume | 73.7% | 0.77 | MASE-only |
| Electricity Cost | 79.0% | 3.01 | MASE-only |
| Thermal Energy Cost | 57.4% | 0.77 | MASE-only |
| Variable Cost per Ton | 65.2% | 2.27 | MASE-only |
...
**Industrial Electricity Price** - MAPE 110.2% and MASE 13.06 both poor
...
**Capacity Utilization** - MAPE 406.8% exceeds threshold 50.0%
- **Analysis:** Review data quality, regressors, and model configuration
- **Recommendation:** Run targeted diagnosis on this variable
...
| Variable | Bias | Alert |
|----------|------|-------|
| EBITDA | -35.70 | Systematic under-prediction detected (bias=-35.70) |
...
| Variable Cost per Ton | -40.65 | Systematic under-prediction detected (bias=-40.65) |
| Capacity Utilization | 31.18 | Systematic over-prediction detected (bias=31.18) |
...
| Industrial Electricity Price | -0.17 | Systematic under-prediction detected (bias=-0.17) |
...
| 11 | Revenue | 1.12 | 12% worse |
| 12 | Building Permits (Portugal) | 1.29 | 29% worse |
| 13 | EBITDA | 1.63 | 63% worse |
| 14 | Capacity Utilization | 1.64 | 64% worse |
| 15 | Variable Cost per Ton | 2.27 | 127% worse |
| 16 | Electricity Cost | 3.01 | 201% worse |
| 17 | Industrial Electricity Price | 13.06 | 1206% worse |
...
3. **EBITDA** - MASE 1.63 (63% worse than naïve)
4. **Capacity Utilization** - MASE 1.64 (64% worse than naïve)
5. **Variable Cost per Ton** - MASE 2.27 (127% worse than naïve)
6. **Electricity Cost** - MASE 3.01 (201% worse than naïve)
7. **Industrial Electricity Price** - MASE 13.06 (1206% worse than naïve)
...
| 11 | Revenue | 43.9 | Poor |
| 12 | Building Permits (Portugal) | 35.3 | Poor |
| 13 | EBITDA | 18.6 | Poor |
| 14 | Capacity Utilization | 17.9 | Poor |
| 15 | Electricity Cost | 0.0 | Poor |
| 16 | Variable Cost per Ton | 0.0 | Poor |
| 17 | Industrial Electricity Price | 0.0 | Poor |

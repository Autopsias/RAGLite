...
Generated: 2026-02-02T13:47:07.395583
Runtime: 478.8 seconds
...
|-----------|--------|--------|--------|
| Variables Passing MAPE | ≥9/25 | 17/25 | ✅ PASS |
...
| Metric | Value | Target | Status | Interpretation |
|--------|-------|--------|--------|----------------|
| MAPE | 230.56% | <100.0% | ❌ FAIL | Critical - needs investigation |
| MASE | 1.51 | <1.0 | ❌ FAIL | Worse than naïve by 51% |
| SMAPE | 186.29% | - | INFO | Symmetric error |
| RMSE | 20.17 | - | INFO | Error in original units |
| MAE | 19.24 | - | INFO | Average absolute error |
| Bias | -19.24 | ~0 | ⚠️ WARN | Tends to under-predict |
| FQS | 15.9/100 | ≥65 | INFO | Poor quality |
...
| GROUP Cash Flow | MASE >1.0 | 1.51 | Evaluate model configuration |
...
**GROUP Cash Flow** - MAPE 230.6% exceeds threshold 100.0%
- **Analysis:** Review data quality, regressors, and model configuration
- **Recommendation:** Run targeted diagnosis on this variable
...
**GROUP Gross Profit** - MAPE 0.0% exceeds threshold 50.0%
- **Analysis:** Review data quality, regressors, and model configuration
- **Recommendation:** Run targeted diagnosis on this variable
...
| GROUP Cash Flow | -19.24 | Systematic under-prediction detected (bias=-19.24) |
...
| 16 | GROUP Cash Flow | 1.51 | 51% worse |
| 17 | Variable Cost per Ton | 1.59 | 59% worse |
| 18 | GROUP Turnover | 1.73 | 73% worse |
| 19 | Sales Volume | 1.79 | 79% worse |
| 20 | Thermal Energy Cost | 7.09 | 609% worse |
...
3. **GROUP Cash Flow** - MASE 1.51 (51% worse than naïve)
4. **Variable Cost per Ton** - MASE 1.59 (59% worse than naïve)
5. **GROUP Turnover** - MASE 1.73 (73% worse than naïve)
6. **Sales Volume** - MASE 1.79 (79% worse than naïve)
7. **Thermal Energy Cost** - MASE 7.09 (609% worse than naïve)
...
| 18 | GROUP Cash Flow | 15.9 | Poor |
| 19 | Sales Volume | 6.9 | Poor |
| 20 | Thermal Energy Cost | 0.0 | Poor |

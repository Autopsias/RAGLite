"""SDMX parsing and period handling edge cases for Eurostat indicators.

Story 6.16: Add Eurostat Construction & Industrial Indicators

This test file covers SDMX parsing logic and date/period handling:
- [P0] SDMX-JSON multi-dimensional index parsing edge cases
- [P1] Period format parsing edge cases (_parse_eurostat_period)
- [P2] Date filtering boundary conditions
- [P1] Integration with regressor_fetch and regressor_config

Run with: pytest tests/unit/external_data/test_eurostat_parsing_edge_cases.py -v
"""

"""Unit tests for proactive insight generation.

Tests the generate_insights() function which orchestrates insight generation
from anomalies, trends, and forecasts. Corresponds to AC1-AC6.
"""

"""Shared fixtures for model selection MCP tests.

This module contains fixtures used by test_model_selection_mcp_cache.py
and test_model_selection_mcp_routers.py to avoid duplication.
"""

"""Unit tests for proactive insight models.

Tests the InsightCategory enum, Insight model, and InsightGenerationResult model.
Corresponds to AC2, AC3, AC5 from Story 4.7.
"""

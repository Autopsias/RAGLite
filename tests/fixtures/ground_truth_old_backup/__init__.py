"""Ground truth test set for RAGLite Phase 1 accuracy validation (OLD BACKUP).
...
This is a BACKUP of the original ground_truth.py file. The active version has been
refactored into a more modular structure in tests/fixtures/ground_truth/.

Usage:
    from tests.fixtures.ground_truth_old_backup import GROUND_TRUTH_QA
...
from tests.fixtures.ground_truth_old_backup.operating_expenses import (
...
_EXPECTED_DIFFICULTIES: dict[str, int] = {
    "easy": 20,
    "medium": 20,
    "hard": 10,
}

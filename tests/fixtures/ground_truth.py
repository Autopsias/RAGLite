...
This module contains 50 validated question-answer pairs for testing RAG system accuracy.
...
Data Structure:
    Each question is a dict with required fields:
    - id: Unique sequential identifier (1-50)
    - question: Natural language query text
    - expected_answer: Validated answer text from PDF
    - expected_keywords: List of keywords for validation
    - source_document: Source PDF filename
    - expected_page_number: Page number in source PDF
    - expected_section: Section identifier in PDF
...
Adding New Questions:
    To add new questions, append to the appropriate category list (e.g., COST_ANALYSIS_QUESTIONS)
    following the structure above. Ensure all required fields are present and validate against
    the actual PDF content before adding.

Last Updated: 2025-10-14
Validated By: Dev Agent (Amelia) - Story 1.14
Validation: All 50 questions manually validated against PDF on 2025-10-14
"""

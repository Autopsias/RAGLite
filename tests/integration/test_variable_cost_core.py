"""Integration tests for entity-specific Variable Cost extraction (Story 6.15) - Core Tests.
...
- Command: TEST_USE_FULL_PDF=true pytest tests/integration/test_variable_cost_core.py

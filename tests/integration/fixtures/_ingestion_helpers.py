...
def _ingest_test_pdf(
    ...
    try:
        ...
        # This prevents nested event loop issues with pytest-asyncio
        try:
            ...
            # Running loop exists - use run_until_complete if we're in the same thread
            # or run_coroutine_threadsafe if called from different thread
            ...
            future.result(timeout=330.0)  # Slightly longer to allow asyncio timeout to fire first

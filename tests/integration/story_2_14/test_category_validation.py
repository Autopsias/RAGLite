#!/usr/bin/env python3
"""Story 2.14 - Ground Truth Validation - Category Tests.

Tests overall accuracy and category-specific validations.
"""
...
from tests.integration.story_2_14.conftest import validate_excerpt_query
...
class TestStory214CategoryValidation:
